/**
 ...
 class SalesforceClient {
    ...
    async login() {
       ...
       general_logger.info('Ingelogd bij Salesforce via jsforce');
    }
    ...
    async createUser(data) {
       ...
       general_logger.info('[CREATE] Salesforce:', result);
    }

    async updateUser(id, data) {
       const result = await this.conn.sobject('Contact').update({ Id: id, ...data });
       general_logger.info('[UPDATE] Salesforce:', result);
    }

    async deleteUser(id) {
       const result = await this.conn.sobject('Contact').destroy(id);
       general_logger.info('[DELETE] Salesforce:', result);
    }
    ...
    async query(query) {
       ...
       general_logger.info('[QUERY] Salesforce:', result);
       return result;
    }
 }
